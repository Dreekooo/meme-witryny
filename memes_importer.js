...
function new_sort(site, sort){
    ...
    if(sort == 1){
        ...
        for(div_num; div_num <=10; div_num++){
            memes_div = memes_div + `<div class = "memes-meme-div"><img src = "m${div_num+((site-1)*10)}.jpg" class="img"></div>`
        }
    } else if(sort == 2){
        div_num = 10
        for(div_num; div_num >=1; div_num--){
            memes_div = memes_div + `<div class = "memes-meme-div"><img src = "m${div_num+((5-site)*10)}.jpg" class="img"></div>`
        }
    }
